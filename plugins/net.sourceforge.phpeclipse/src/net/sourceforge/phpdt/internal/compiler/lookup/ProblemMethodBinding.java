...
public class ProblemMethodBinding extends MethodBinding {
	...
	public ProblemMethodBinding(char[] selector, TypeBinding[] args,
			int problemId) {
	...
	public ProblemMethodBinding(char[] selector, TypeBinding[] args,
			ReferenceBinding declaringClass, int problemId) {
		this.selector = selector;
		this.parameters = (args == null || args.length == 0) ? NoParameters
				: args;
	...
	public ProblemMethodBinding(MethodBinding closestMatch, char[] selector,
			TypeBinding[] args, int problemId) {
