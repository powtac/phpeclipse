...
public interface IJavaModelMarker {
	 ...
	 * <code>"net.sourceforge.phpdt.core.problem"</code>). This can be used
	 ...
	 * <code>"net.sourceforge.phpdt.core.transient_problem"</code>). This can
	 ...
	 * <code>"net.sourceforge.phpdt.core.task"</code>). This can be used to
	 ...
	 * customized through <code>PHPCore</code> option
	 * <code>"net.sourceforge.phpdt.core.compiler.taskTag"</code>.
	 * 
	 * @since 2.1
	 */
	 ...
	 * <code>"net.sourceforge.phpdt.core.buildpath_problem"</code>). This can
